...
const Regional = () => {
  ...
  // Filter and sort provinces from dummy data
  const filteredAndSortedProvinces = useMemo(() => {
    ...
    filtered.sort((a, b) => {
      ...
      if (sortBy === 'projects') {
        ...
        aValue = a[sortBy as keyof Omit<Province, 'id' | 'population'>];
        bValue = b[sortBy as keyof Omit<Province, 'id' | 'population'>];
      }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 pt-24 pb-8">
        {/* Header Section */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold" style={{ color: '#3338A0' }}>Regional Transparansi Dana</h1>
