...
// Data provinsi dengan ID sesuai database
const provinces = [
  ...
  // tambahkan provinsi lainnya sesuai dengan data di database
];
...
export default function UploadProposal() {
  ...
  const [formData, setFormData] = useState({
    projectName: "",
    ethAmount: "",
    regionId: "", // ubah dari region ke regionId
    category: "",
    description: "",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Data project (sesuai dengan handler backend)
      submitFormData.append("judul", formData.projectName);
      submitFormData.append("kategori", formData.category);
      submitFormData.append("deskripsi", formData.description);
      submitFormData.append("budget", formData.ethAmount);
      
      // Region ID (convert ke integer)
          ...
          <CardContent className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-between pt-6">
                ...
                {currentStep === 2 && (
                  <Button type="submit" disabled={!isStep2Valid || isSubmitting}>
